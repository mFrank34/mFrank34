...
- 🚀 Currently working on **[Portfolio](https://github.com/mFrank34/Portfolio)**
- 🧠 Currently Enhancing **Python** and **Fastapi**
- 💬 Check out my most invested project: **[Life](https://github.com/mFrank34/Life)**
- 🌐 Learning Cloud to run Services on **PaaS** with using [Railway](https://railway.com/)
